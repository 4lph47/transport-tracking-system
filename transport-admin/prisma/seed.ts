...
async function main() {
  ...
  const proprietario1 = await prisma.proprietario.create({
    data: {
      ...
      dataInicioOperacoes: new Date('1975-05-15'),
  ...
  const proprietario2 = await prisma.proprietario.create({
    data: {
      ...
      bi: '110204567890B',
      nacionalidade: 'Moçambicana',
      dataInicioOperacoes: new Date('1980-08-22'),
    ...
    data: [
      {
        ...
        contatoEmergencia: 'Isabel Silva (Esposa)',
        dataEmissaoBI: new Date('2020-01-15'),
        dataValidadeBI: new Date('2030-01-15'),
        dataEmissaoCarta: new Date('2018-06-20'),
        dataValidadeCarta: new Date('2028-06-20'),
      },
      {
        nome: 'Maria Santos Costa',
        bi: '110204567890B',
        ...
        contatoEmergencia: 'António Costa (Irmão)',
        dataEmissaoBI: new Date('2019-05-10'),
        dataValidadeBI: new Date('2029-05-10'),
        dataEmissaoCarta: new Date('2017-03-15'),
        dataValidadeCarta: new Date('2027-03-15'),
      },
      {
        ...
        contatoEmergencia: 'Rosa Nhaca (Mãe)',
        dataEmissaoBI: new Date('2021-03-20'),
        dataValidadeBI: new Date('2031-03-20'),
        dataEmissaoCarta: new Date('2016-09-10'),
        dataValidadeCarta: new Date('2026-09-10'),
      },
      {
        nome: 'Pedro Macamo',
        bi: '110206789012D',
        ...
        contatoEmergencia: 'Júlia Macamo (Irmã)',
        dataEmissaoBI: new Date('2020-08-12'),
        dataValidadeBI: new Date('2030-08-12'),
        dataEmissaoCarta: new Date('2019-02-25'),
        dataValidadeCarta: new Date('2029-02-25'),
      },
      {
        nome: 'Ana Sitoe',
        bi: '110207890123E',
        ...
        contatoEmergencia: 'Manuel Sitoe (Pai)',
        dataEmissaoBI: new Date('2019-11-05'),
        dataValidadeBI: new Date('2029-11-05'),
        dataEmissaoCarta: new Date('2018-07-18'),
        dataValidadeCarta: new Date('2028-07-18'),
      },
    ],
  });
  ...
  // Criar Histórico de Localização com coordenadas reais
  await prisma.geoLocation.createMany({
    data: [
      {
        geoLocationTransporte: '-25.9723,32.5836',
      ...
      {
        geoLocationTransporte: '-25.9442,32.5639',
        geoDirection: 'Terminal Zimpeto',
        codigoTransporte: 1002,
        transporteId: transporte2.id,
        geoLocationHist1: '-25.9734,32.5694',
        geoLocationHist2: '-25.9600,32.5650',
        geoLocationHist3: '-25.9442,32.5639',
        geoDateTime1: new Date(Date.now() - 20 * 60000),
        geoDateTime2: new Date(Date.now() - 12 * 60000),
        geoDateTime3: new Date(Date.now() - 6 * 60000),
      },
      {
        geoLocationTransporte: '-25.8373,32.6382',
        geoDirection: 'Terminal Zimpeto',
        codigoTransporte: 1003,
        transporteId: transporte3.id,
        geoLocationHist1: '-25.9734,32.5694',
        geoLocationHist2: '-25.9328,32.5518',
        geoLocationHist3: '-25.8373,32.6382',
        geoDateTime1: new Date(Date.now() - 18 * 60000),
        geoDateTime2: new Date(Date.now() - 11 * 60000),
        geoDateTime3: new Date(Date.now() - 4 * 60000),
      },
    ],
  });

  console.log('✅ Histórico de localização criado');
