    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-[1600px] mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900">Histórico de Relatórios</h2>
            <p className="text-gray-600 mt-1">Veja todos os relatórios gerados anteriormente</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              O histórico de relatórios está em desenvolvimento.
            </p>
            <button
              onClick={() => router.push('/relatorios')}
